...
import org.idempierelbr.base.provider.DefaultTaxProvider;
...
public class MLBRNotaFiscalLine extends X_LBR_NotaFiscalLine {
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
		...
		DefaultTaxProvider calculator = new DefaultTaxProvider();
	...
	public ICMSBean getICMSBean() {
		MLBRDocLineICMS[] icmsLines = MLBRDocLineICMS.getOfDetails(MLBRDocLineDetails.getOfPO(this));
	...
	public IPIBean getIPIBean() {
		MLBRDocLineIPI[] ipiLines = MLBRDocLineIPI.getOfDetails(MLBRDocLineDetails.getOfPO(this));
	...
	public IIBean getImportTaxBean() {
		MLBRDocLineImportTax[] iiLines = MLBRDocLineImportTax.getOfDetails(MLBRDocLineDetails.getOfPO(this));
	...
	public PISBean getPISBean() {
		MLBRDocLinePIS[] pisLines = MLBRDocLinePIS.getOfDetails(MLBRDocLineDetails.getOfPO(this));
	...
	public COFINSBean getCOFINSBean() {
		MLBRDocLineCOFINS[] cofinsLines = MLBRDocLineCOFINS.getOfDetails(MLBRDocLineDetails.getOfPO(this));
	...
	public ISSQNBean getISSQNBean() {
		MLBRDocLineISSQN[] issqnLines = MLBRDocLineISSQN.getOfDetails(MLBRDocLineDetails.getOfPO(this));
