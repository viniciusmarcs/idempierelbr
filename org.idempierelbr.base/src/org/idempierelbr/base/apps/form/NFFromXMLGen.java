package org.idempierelbr.base.apps.form;
...
public class NFFromXMLGen
{
	...
	private String createNotaFiscal() {
		...
		for (int i = 1; i <= xmlProductMap.size(); i++) {
			...
			MLBRDocLineDetails details = MLBRDocLineDetails.createFromPO(line);
	 ...
	 */
	private MLBRDocLineICMS createICMS(Properties ctx, MLBRDocLineDetails details, Element element, String trxName) {
	 ...
	 * @param element 
	 */
	private MLBRDocLineIPI createIPI(Properties ctx, MLBRDocLineDetails details, Element element, String trxName) {
	 ...
	 */
	private MLBRDocLineImportTax createII(Properties ctx, MLBRDocLineDetails details, Element element, String trxName) {
	 ...
	 */
	private MLBRDocLinePIS createPIS(Properties ctx, MLBRDocLineDetails details, Element element, String trxName) {
	 ...
	 */
	private MLBRDocLineCOFINS createCOFINS(Properties ctx, MLBRDocLineDetails details, Element element, String trxName) {
	 ...
	 */
	private MLBRDocLineISSQN createISSQN(Properties ctx, MLBRDocLineDetails details, Element element, String trxName) {
	 ...
	 */
	public void generateLBRTaxFromNFeTaxes(Properties ctx, MLBRNotaFiscalLine nfline, MLBRDocLineDetails details,
	 ...
	 * @throws Exception
	 */
	public void createLBRTaxLineICMS(Properties ctx, int LBR_Tax_ID, int C_Tax_ID, MLBRDocLineDetails details,
			String trxName) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void createLBRTaxLinePIS(Properties ctx, int LBR_Tax_ID, int C_Tax_ID, MLBRDocLineDetails details,
			String trxName) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void createLBRTaxLineCOFINS(Properties ctx, int LBR_Tax_ID, int C_Tax_ID, MLBRDocLineDetails details,
			String trxName) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void createLBRTaxLineIPI(Properties ctx, int LBR_Tax_ID, int C_Tax_ID, MLBRDocLineDetails details,
			String trxName) throws Exception {
