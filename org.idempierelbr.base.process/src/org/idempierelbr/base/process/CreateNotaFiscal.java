...
public class CreateNotaFiscal extends SvrProcess
{
	...
	protected String doIt() throws Exception {
		...
		for (PO poLine : poLines) {
			...
			MLBRDocLineDetails details = MLBRDocLineDetails.createFromPO(nfLine);
			
			if (details != null) {
				details.copyFrom(MLBRDocLineDetails.getOfPO(poLine));
				//details.saveEx();
				details.copyChildren(MLBRDocLineDetails.getOfPO(poLine));
			}
